...
INSERT INTO public.products (name, default_price, currency_string, description, category_id, supplier_id) VALUES
    ...
    ('EA Controller', 0.009, 'BTC', 'Buy this to buy microtransactions in-game... when the game eventually comes out.', 2, 10),
    ('Lightsaber', 0.066, 'BTC', 'The force be with you.', 2, 8),
    ('M4A4 Dragon King', 0.046, 'BTC', 'A weapon worthy of the Monkey King himself.', 2, 7),
